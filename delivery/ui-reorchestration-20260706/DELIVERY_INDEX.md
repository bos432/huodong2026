...
| 目录 | 内容 |
| --- | --- |
| `.local-logs/browser-acceptance-20260706023021` | PC 后台 + H5 页面级验收 `result.json` 和截图 |
| `.local-logs/mobile-admin-acceptance-20260706023133` | 手机管理端页面级验收 `result.json` 和截图 |
...
- 本次新增修复商城商品/优惠券保存严格校验问题，部署后台静态包后生效。
