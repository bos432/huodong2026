...
const mallEntities = [Tenant, User, AdminUser, Agent, OperationSetting, AdminOperationLog, UserWallet, WalletTransaction, MemberLevel, MemberProfile, MemberPointLog, MallCategory, MallCoupon, MallCouponClaim, MallCouponUsage, MallCommission, MallPromotionCode, MallFavorite, MallBrowseHistory, MallFlashSale, MallGroupBuy, MallGroupBuyRecord, MallLogisticsCompany, MallProduct, MallSku, MallInventoryLog, MallAddress, MallCartItem, MallOrder, MallOrderItem, MallPaymentCallbackLog, MallPaymentTransaction, MallRefund, MallRefundLog, MallReview];
