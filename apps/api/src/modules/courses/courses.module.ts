...
@Module({
  imports: [TypeOrmModule.forFeature([Course, CourseChapter, CourseLesson, CommunityActivity, CheckInTask, CommunityPost, UserLearning, UserFavorite, Certificate, AdminUser])],
