...
.activity-preview-card { display: grid; grid-template-columns: 76rpx 188rpx minmax(0, 1fr); gap: 14rpx; align-items: stretch; min-height: 204rpx; padding: 14rpx; border: 1rpx solid var(--app-border); border-radius: 16rpx; background: #fff; box-shadow: none; }
.activity-date { display: grid; align-content: center; justify-items: center; gap: 3rpx; border-radius: 8rpx; background: #eafbf1; color: #078347; font-size: var(--app-font-helper); font-weight: 800; }
...
.activity-category,.activity-status { max-width: 50%; overflow: hidden; padding: 4rpx 8rpx; border-radius: 5rpx; text-overflow: ellipsis; white-space: nowrap; font-size: var(--app-font-caption); font-weight: 800; }
...
.activity-foot { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; min-width: 0; color: #809087; font-size: var(--app-font-helper); }.activity-foot text:first-child { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
