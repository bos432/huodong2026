...
const sampleActivities = [
  { id: 1, title: "东方生活美学体验", startTime: "07-25 14:00", location: "城市文化空间", price: 0, remainingSeats: 12, coverUrl: "" },
  { id: 2, title: "周末主题共修会", startTime: "07-27 09:30", location: "慢π活动中心", price: 68, remainingSeats: 8, coverUrl: "" }
];
const samplePosts = [
