  ...
  routes: [
    ...
    { path: "/invite", component: AdminInviteAccept },
    {
      ...
      children: [
        ...
        { path: "brand-settings", component: SystemSettings, meta: { roles: ["system.view", "operation_settings.view"], scope: "tenantOrPlatformAdmin" } },
...
function fallbackPath() {
  ...
  const candidates = [
    ...
    { path: "/brand-settings", roles: ["system.view", "operation_settings.view"], scope: "tenantOrPlatformAdmin" },
