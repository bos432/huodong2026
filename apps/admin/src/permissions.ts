...
export const adminPermissionGroups = [
  ...
  { group: "装修营销", items: [{ key: "homepage.manage", label: "首页装修" }, { key: "marketing_popup.manage", label: "营销弹窗" }, { key: "announcement.manage", label: "公告管理" }, { key: "operation_settings.manage", label: "运营设置" }, { key: "upload.image", label: "上传图片" }] },
...
export function defaultPermissionsForRole(role?: string | null, tenantScoped = false) {
  ...
  if (normalized === AdminRole.Operator) return [
    ...
    "mall.merchant.view", "mall.product.manage", "mall.review.manage", "mall.logistics.manage", "mall.order.view", "mall.order.manage", "homepage.manage", "marketing_popup.manage", "announcement.manage", "operation_settings.manage", "tenant_profile.manage", "charity.view", "charity.manage",
