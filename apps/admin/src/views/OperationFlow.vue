...
const lanes: FlowLane[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "发布课程/共修", owner: "慢π运营", description: "配置课程、课时、课程价格、共修活动和打卡任务。", outputs: ["课程列表", "共修任务", "打卡入口"] },
  ...
  },
  {
    ...
    steps: [
      { title: "进入 H5/小程序", owner: "用户", description: "可通过商家链接、二维码、tenantCode、手动切换进入指定城市/商家；没有指定商家时，系统会尝试用定位匹配区域商家。", outputs: ["首页", "活动列表", "课程列表"] },
...
const regionalChecks = [
  ...
  "手动切换：用户拒绝定位或定位失败时，可以手动选择城市/商家，并记住本次选择。",
